# 🔢 Sammlungs-Zauber 2: Auf Einträge zugreifen

Jeder Eintrag hat eine Nummer, den **Index**. Wichtig: Das Zählen beginnt bei **0**!

```python
schaetze = ["Gold", "Kristall", "Amulett", "Krone", "Ring"]
print(schaetze[0])    # erster Eintrag
print(schaetze[1])    # zweiter Eintrag
print(schaetze[-1])   # letzter Eintrag
schaetze[0] = "Schlüssel"   # Eintrag ersetzen
```
