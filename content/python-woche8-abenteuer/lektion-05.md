# ⚔️ Archiv-Zauber 5: Tupel

Ein **Tupel** ist wie eine Liste, aber **unveränderlich**. Du schreibst es mit runden Klammern:

```python
artefakt = ("Feuerstab", 15, "Feuer")
print(artefakt[0])          # Feuerstab – Zugriff über die Position wie bei Listen
print(len(artefakt))        # 3

name, wert, sorte = artefakt   # Unpacking: drei Variablen auf einmal
