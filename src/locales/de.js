export default {
  ...
  'home.cta.placementHint': 'Nicht sicher, wo du starten sollst?',
  ...
  'courseFormat.einstieg': 'Einstieg',
  'courseFormat.grundkurs': 'Grundkurs',
  ...
  'lessons.section.lektion': 'Lektion',
  'lessons.section.debug':   'Debug',
  'lessons.section.boss':    'Extra-Herausforderung',
  'lessons.section.mission': 'Mission',
  ...
  'jsLesson.badgeExample': '🔍 Beispiel – nur ausführen',
  'jsLesson.badgeRequired':'✏️ Deine Aufgabe',
  ...
  'projekte.filter.title': 'Filtern nach',
  'projekte.filter.language': '🌐 Sprache',
  'projekte.filter.level': '🎯 Level',
  'projekte.filter.tags': '🏷️ Thema',
  'projekte.filter.duration': '⏱️ Dauer',
