...
held = Spieler("Tom", "labor")
held.nimm("Schweißbrenner")
speichern_komplett(held)
welt["labor"]["gegenstaende"] = [Gegenstand("Müll", "Nur Schrott.")]
held = laden_komplett()
held.zeige_inventar()
print("Im labor liegt:", [g.name for g in welt["labor"]["gegenstaende"]])