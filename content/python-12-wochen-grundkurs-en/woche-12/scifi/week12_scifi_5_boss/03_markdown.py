...
The game state from the lesson has a weakness: it does not remember **which items are still lying in the rooms** and how much life the enemy has left. After loading, `Cutter` would be back again!
...
**Step 3 – Prove it:**
Let a player take `Cutter`, save, deliberately wreck the contents of the room `"lab"`, load – and check that the room is right again.
