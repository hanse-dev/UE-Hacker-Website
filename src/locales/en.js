export default {
  ...
  'home.hero.subtitle': 'Your journey into the world of programming starts here. Learn Python or JavaScript in a way that is actually fun.',
  'home.cta.courses':      'Browse Courses',
  'home.cta.projects':     'Browse Projects',
  'home.cta.placement':   'Placement test',
  'home.cta.placementHint': 'Not sure where to start?',
  ...
  'courseFormat.einstieg': 'Beginner',
  'courseFormat.grundkurs': 'Full course',
  ...
  'lessons.section.lektion': 'Lesson',
  'lessons.section.debug':   'Debug',
  'lessons.section.boss':    'Extra challenge',
  ...
  'jsLesson.badgeExample': '🔍 Example – just run it',
  'jsLesson.badgeRequired':'✏️ Your task',
  ...
  'projekte.filter.title': 'Filter by',
  'projekte.filter.language': '🌐 Language',
  'projekte.filter.level': '🎯 Level',
  'projekte.filter.tags': '🏷️ Topic',
  'projekte.filter.duration': '⏱️ Length',
