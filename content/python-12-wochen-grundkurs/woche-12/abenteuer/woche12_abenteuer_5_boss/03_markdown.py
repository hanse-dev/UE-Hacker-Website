...
Der Spielstand aus der Lektion hat eine Schwäche: Er merkt sich nicht, **welche Gegenstände noch in den Räumen liegen** und wie viel Leben der Gegner noch hat. Nach dem Laden wäre `Schwert` also wieder da!
...
**Schritt 3 – Beweisen:**
Lass einen Spieler `Schwert` nehmen, speichere, zerstöre absichtlich den Inhalt des Raums `"quelle"`, lade – und prüfe, dass der Raum wieder stimmt.
