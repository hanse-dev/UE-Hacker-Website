"""# 📖 Glossar – 🧙 Woche 5 – Funktionen: Die Zauberformeln der Macht
> Dieses Notebook kannst du die ganze Woche offen lassen.

| Begriff | Bedeutung | Beispiel |
|---------|-----------|----------|
| `def` | Funktion definieren – wiederverwendbaren Code-Block erstellen | `def begrüße(name):` |
| **Parameter** | Eingabewerte einer Funktion | `def add(a, b):` |
