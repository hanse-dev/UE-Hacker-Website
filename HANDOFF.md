...
> ZIP-Download neu gebaut (3.55), Woche 2 Abenteuer+Pferde+Sci-Fi DE/EN angeglichen (3.56/3.57) —
> Branch `python-lektionen-nacharbeiten` ist gemergt und gelöscht. Damit ist der 12-Wochen-Kurs
> im Lektions-Format komplett DE/EN-angeglichen. Branch `kurs-python-projekte` (offen): Vigenère-
> Chiffre (3.58) und Snake (3.59) hinzugefügt, `npm run test:checks` grün (342 Tests) — Vigenère
> committet, Snake noch nicht.
