...
world = {
    "yard": {
        ...
        "exits": {"north": "aisle"},
        "items": [Item("Flashlight", "It shines in dark corners.")],
        "enemy": None,
    },
    "aisle": {
    ...
    "tackroom": {
        ...
        "exits": {"east": "aisle"},
        "items": [Item("Broom", "A sturdy broom. It helps to chase off the billy goat.")],
        "enemy": None,
    },
    "paddock": {
        "description": "The paddock at night. The foal stands in the grass – and in front of it an angry billy goat!",
        "exits": {"west": "aisle"},
        "items": [Item("Foal", "The little foal follows you trustingly.")],
        "enemy": Enemy("Billy Goat", 15, 6),
    },
}
...
def execute(player, text):
    try:
        ...
        print("🤔 I only understand commands made of two words, e.g. 'go north' or 'take Flashlight'.")
        return
    if action == "go":
        player.go(target)
        check_enemy(player)
