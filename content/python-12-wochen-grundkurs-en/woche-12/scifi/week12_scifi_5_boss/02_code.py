...
world = {
    "airlock": {
        ...
        "items": [Item("Keycard", "It opens secured doors.")],
        "enemy": None,
    },
    "corridor": {
    ...
    "lab": {
        ...
        "exits": {"east": "corridor"},
        "items": [Item("Cutter", "A tool that also stops broken robots.")],
        "enemy": None,
    },
    "reactor": {
        "description": "The reactor room! The reactor hums – and in front of it stands a broken maintenance robot!",
        "exits": {"west": "corridor"},
        "items": [Item("Powerkey", "The red emergency shutdown key of the reactor.")],
        "enemy": Enemy("Maintenance Robot", 15, 6),
    },
}
