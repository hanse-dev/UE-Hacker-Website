...
> Zertifikate aus allen Kursen mit Wochen-Check (Python + KI-Labor) + "Kurs starten"-Gate für die
> 3 Wochen-Tour-Kurse, das die Marketing-Inhalte (Beschreibung/Struktur-Erklärung) vor der
> eigentlichen Kurs-Tour ausblendet (3.69). Vorheriger Stand (Branch `kurs-ki-labor`, noch nicht
