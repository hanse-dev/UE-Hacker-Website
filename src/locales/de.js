export default {
  ...
  'progress.intro1': 'Für jede Woche gibt es ein Zertifikat (Abenteuer-, Pferde- oder Sci-Fi-Zertifikat je nach Questreihe). Du bekommst es, wenn du alle Missionen und die Boss-Quest der Woche erledigt UND den Wochen-Check (Quiz + Coding-Aufgabe) bestanden hast.',
  'progress.intro2': 'Hak jede Mission ab, sobald du sie gemeistert hast, und mach den Check-Tab der Woche – dann schaltet sich das Zertifikat automatisch frei. 🎉',
  ...
  'progress.script.p1':       'Wenn du die Notebooks lokal in Jupyter oder VS Code ausführst, kannst du trotzdem deine erledigten Missionen speichern:',
  ...
  'progress.weekly.hint':     'Pro Woche gibt es 3 Missionen + Boss-Quest. Sind alle erledigt und der Wochen-Check bestanden, bekommst du das Zertifikat dieser Woche.',
  'progress.week.certificate.earned': '🎓 Verliehen',
  'progress.week.certificate.locked': 'Noch nicht verliehen',
  'progress.hint':            'Hak deine Missionen ab und mach den Wochen-Check, um dein erstes Zertifikat zu bekommen!',
