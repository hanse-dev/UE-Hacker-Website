# HANDOFF-Historie (kalt)

Vollständige Feature-Historie (früher HANDOFF.md Abschnitt 3.1–3.46), unverändert ausgelagert.
**Nicht** per `@` in CLAUDE.md importiert — nur bei Bedarf gezielt lesen (z.B. `grep -n "^### 3.32" docs/archiv/HANDOFF-historie.md`).
Die wiederverwendbaren Fallstricke stehen gebündelt in `HANDOFF.md` unter "Gelernte Regeln".
