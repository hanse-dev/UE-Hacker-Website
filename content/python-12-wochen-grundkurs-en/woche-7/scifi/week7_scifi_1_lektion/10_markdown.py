"""## ✨ Module Collection 3: The random Module - The Random Generator

**The most powerful random functions:**
...
**Choosing from lists:**
- `random.choice(list)` - One random element
- `random.choices(list, k=n)` - n random elements
