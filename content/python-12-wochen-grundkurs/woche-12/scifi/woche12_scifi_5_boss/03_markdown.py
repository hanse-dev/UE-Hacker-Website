...
Der Spielstand aus der Lektion hat eine Schwäche: Er merkt sich nicht, **welche Gegenstände noch in den Räumen liegen** und wie viel Leben der Gegner noch hat. Nach dem Laden wäre `Schweißbrenner` also wieder da!
...
**Schritt 3 – Beweisen:**
Lass einen Spieler `Schweißbrenner` nehmen, speichere, zerstöre absichtlich den Inhalt des Raums `"labor"`, lade – und prüfe, dass der Raum wieder stimmt.
